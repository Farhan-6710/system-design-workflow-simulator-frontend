...
export const initialNodes: Node[] = [
  ...
  // createNodeFromOption("service", 3, "Service", 545, 190), // 515 + 40
  createNodeFromOption("service", 4, "Service", 545, 280), // 515 + 40
  // createNodeFromOption("service", 5, "Service", 545, 370), // 515 + 40
  ...
  // createNodeFromOption("sync-compute", 9, "Server", 710, 160), // 645 + 50
  // createNodeFromOption("sync-compute", 10, "Server", 710, 190), // 645 + 50
  // createNodeFromOption("sync-compute", 11, "Server", 710, 220), // 645 + 50
  createNodeFromOption("sync-compute", 12, "Server", 710, 200), // 645 + 50
  createNodeFromOption("sync-compute", 13, "Server", 710, 280), // 645 + 50
  createNodeFromOption("sync-compute", 14, "Server", 710, 360), // 645 + 50
  // createNodeFromOption("sync-compute", 15, "Server", 710, 340), // 645 + 50
  // createNodeFromOption("sync-compute", 16, "Server", 710, 370), // 645 + 50
  // createNodeFromOption("sync-compute", 17, "Server", 710, 400), // 645 + 50
  // Databases - push 55px right (was 35px, now +20px more)
  // createNodeFromOption("database", 18, "User DB", 800, 190), // 705 + 55
  createNodeFromOption("database", 19, "Order DB", 800, 280), // 705 + 55
  // createNodeFromOption("database", 20, "Pay DB", 800, 370), // 705 + 55
];
